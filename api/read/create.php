<?php 
    ...
    $article = array(
        'head' => 'testing korbo na to kibhabe bujhbo thik ki na?2',
        ...
        'write_date' =>  '2021-09-01 18:21:30',
        'domain' =>  'Tech, Web development',
        'sub_domain' =>  'Node js, Python',
        'status' => 0,
        'views' => 0,
        'likes' => 0,
        'image_count' => 0,
        'user_id' => 'abc0123',
        'article_id' => 'abc911 2021-09-01 18:21:30',
        'facebook_link' => 'https://www.facebook.com/abhiroop.basak',
        'twitter_link' => 'https://twitter.com/abhiroop_basak',
        'linkdin_link' => 'https://www.linkedin.com/in/abhiroopbasak/'
    );
